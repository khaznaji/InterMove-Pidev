...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.csrf()
                ...
                .antMatchers("/Events/events/{id}/image").permitAll()
                ...
                .antMatchers("/Events/eventId/{{id}}").permitAll()
                .antMatchers("/Events/employees/{{id}}").permitAll()
                .antMatchers("/Events/image/{{id}}").permitAll()
                .antMatchers("/Claim/add").permitAll()
                .antMatchers("/Claim/Claimedit/{{id}}").permitAll()
                .antMatchers("/Events/events/{eventId}/image").permitAll()
                .antMatchers("/Events/images/{{imageName}}").permitAll()
...
//rayen
                ...
                .antMatchers("/Events/addEvent").permitAll()
